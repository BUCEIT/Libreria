 //Pongo a escuchar la carga de la pagina
            ...
            function traer(){
                ...
                obj.onreadystatechange=function(){
                    if((obj.status==200)&&(obj.readyState==4)){
                        ...
                        for(i=0;i<respuesta.length;i++){
                            ...
                            option.setAttribute("value",respuesta[i]["nif"]);
                ...
                obj.open("get","../includes/traer.php?pag=2");//(metodo,url,si es asincrona,usuario,contraseña) Ahora el estado vale 1, 
            ...
            function borra(){
                ...
                //Tambien le puedo pasar parametros y variables a la vez que establezco la conexion concatenando en la url
                obj2.open("get","../includes/delete.php?pag=2&dato="+dato);//(metodo,url,si es asincrona,usuario,contraseña) Ahora el estado vale 1, 
                //Enviamos la peticion al servidor
