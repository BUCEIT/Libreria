...
<html>
    <head>
        ...
        <script src="../script/BajaLibros.js" type="text/javascript"></script>
    </head>
    <body>
        ...
        ?>
            <div class="container-fluid col-8" id="centro">
                <h2>Baja de libros <img src="../imagenes/books-stack-of-three.png" alt=""/></h2>
                <select class="form-control col-sm-10 col-md-10 col-lg-10">

                </select>
                <button class="btn btn-primary mt-2">Borrar libros</button>
                <p></p>
            </div>
