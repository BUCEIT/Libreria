...
<html>
    <head>
        ...
        <script src="../script/BajaEditoriales.js" type="text/javascript"></script>
    </head>
    <body>
        ...
        ?>
            <div class="container-fluid col-8" id="centro">
                <h2>Baja de editoriales <img src="../imagenes/graphic-design.png" alt=""/></h2>
                <select class="form-control col-sm-10 col-md-10 col-lg-10">

                </select>
                <button class="btn btn-primary mt-2">Borrar Editoriales</button>
                <p></p>
            </div>
